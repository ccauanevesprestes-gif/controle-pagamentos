Claro. Como você pediu um README, segue um texto mais natural, como se tivesse sido escrito por um estudante ou desenvolvedor documentando o projeto.
...
Atualmente, a opção **1 (Receber documentos)** aparece no menu, mas ainda não foi implementada no código.
